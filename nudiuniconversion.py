...
#     # Example Nudi text for testing
#     nudi_text = "£ÀªÀÄä ¸ÀAWÀPÉÌ PÀÈ¶ GvÀà£ÀßUÀ¼À ¸ÀAUÀæºÀuÉ, ¸ÀA¸ÀÌgÀuÉ ªÀiÁqÀÄªÀ GzÉÝÃ±ÀPÉÌ MAzÀÄ UÉÆÃzÁ«Ä£À CªÀ±ÀåPÀvÉAiÀÄ£ÀÄß ªÀÄ£ÀUÀAqÀÄ."  # Replace this with your ASCII text

#     # Process the string directly
#     processed_line = process_line(nudi_text)

#     # Print the processed output
#     print("[DEBUG] Original content:")
#     print(nudi_text)  # Log the original content for debugging
#     print("[DEBUG] Processed content:")
#     print(processed_line)  # Log the processed content
...
#             content = f.read()  # Read the entire input
#             print("[DEBUG] Original content read from file:")
#             print(content)  # Log the original content for debugging

#             processed_line = process_line(content)  # Process the entire input
#             print("[DEBUG] Processed content:")
#             print(processed_line)  # Log the processed content
...
#             else:
#                 with open(params.output, 'w', encoding='utf-8') as f_out:
...
#     #     try:
#     #         with codecs.open(params.input, encoding="cp1252", errors="ignore") as f:
#     #             processed_line = process_line(f.read())
#     #             if params.output is None:
#     #                 sys.stdout.write(processed_line + "\n")
#     #             else:
#     #                 with open(params.output, 'w', encoding='utf-8') as f_out:
